    ...
    const onScroll = () => {
      ...
      navRaf = requestAnimationFrame(() => {
        ...
        if (hero && isHomePage) {
          ...
          if (sy > heroH * (isPhone ? 0.94 : 0.65)) navP = 1;
          ...
          document.body.classList.toggle('past-hero', isPhone ? sy > heroH * 0.76 : navP > 0.02 || sy > heroH * 0.5);
          document.body.classList.toggle('nav-revealed', navP > 0.95 || sy > heroH * (isPhone ? 0.94 : 0.65));
