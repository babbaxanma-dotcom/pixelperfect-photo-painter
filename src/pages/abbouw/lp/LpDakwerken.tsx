...
.tr-lc-row--calc { transition: border-color .15s ease, box-shadow .15s ease, background-color .15s ease, color .15s ease; }
.tr-lc-row--calc:active { }
.tr-lc-row--calc.is-opening { background: #f7f9fc; }
.tr-lc-row--calc.is-opening .tr-lc-title { color: ${ORANGE_H}; }
.tr-lc-row--calc.is-opening .tr-lc-chev { color: ${NAVY}; }
