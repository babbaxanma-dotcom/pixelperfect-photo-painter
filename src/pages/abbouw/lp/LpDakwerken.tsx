...
import imgOnderhoud from '@/assets/dak/lp-classic-renovatie.jpg';
  ...
  <div class="tr-quickform-shell">
    <div class="tr-wrap">
      <div class="tr-quickform" id="lp-form" data-lp-quick>
        <h3>Vraag uw gratis dakinspectie</h3>
        <form data-lp-quick-form novalidate>
          <div class="tr-qf-grid">
            ...
            <button type="submit" class="tr-btn" data-lp-quick-submit>
              <span data-lp-quick-submit-label>Plan mijn dakinspectie</span>
            </button>
          </div>
        </form>
