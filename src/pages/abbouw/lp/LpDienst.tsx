...
import imgOpSteps from '@/assets/lp-diensten/oprit-steps.jpg';
import imgZwSteps from '@/assets/lp-diensten/zwembad-steps.jpg';
...
export const DIENSTEN: Record<string, Dienst> = {
  totaalrenovatie: {
    ...
    offerIntro: 'Bij een totaalrenovatie hangt elke fase aan de vorige: leidingen moeten in de muur voor er gepleisterd wordt, en de chape moet droog zijn voor de vloer erop kan. Wij zetten die volgorde vooraf op papier en bewaken de planning tot de oplevering.',
    ...
    steps: [['Gratis plaatsbezoek', 'Een vakman loopt de woning door en vraagt wat u ermee wil. Soms is het antwoord dat u beter in fases werkt, en dan zeggen we dat ook.'], ['Vaste offerte', 'Eén bedrag voor de hele renovatie, met per onderdeel wat erin zit. Stijgt materiaal daarna, dan draaien wij daarvoor op.'], ['Uitvoering door eigen ploeg', 'Ruwbouw, technieken, chape, pleisterwerk, vloeren. Onze mensen doen het zelf, in de volgorde die op de planning staat.']],
    ...
    reviews: [{ text: '"Oude rijwoning volledig laten strippen en heropbouwen. Zeven maanden werk, goed opgevolgd van begin tot eind. Heel tevreden."', name: 'Geert Vandenbussche', role: 'Volledige renovatie rijwoning' }, { text: '"Woning uit de jaren zeventig van binnen helemaal vernieuwd: elektriciteit, sanitair, isolatie en afwerking. Netjes gewerkt en elke vrijdag opgekuist."', name: 'Annelies Verstraeten', role: 'Totaalrenovatie woning' }, { text: '"Ze raadden aan om de keuken een jaar later te doen in plaats van alles ineens. Eerlijk advies. Beide fases liepen zoals gepland."', name: 'Ian Copsu', role: 'Gefaseerde renovatie' }],
    faq: [['Wat kost een totaalrenovatie?', 'Dat hangt sterk af van de staat van de woning, de oppervlakte en de gewenste afwerking. Wat de ene woning aan technieken kost, gaat bij de andere naar de ruwbouw. Na het gratis plaatsbezoek krijgt u een bedrag met per onderdeel wat erin zit, en daar blijft het bij.'], ['Krijg ik echt één vaste prijs voor alles?', 'Ja. U krijgt één offerte voor de volledige renovatie, met per onderdeel wat erin zit. Dat bedrag verandert niet meer, ook niet als materiaal ondertussen duurder wordt. Vraagt u zelf om extra werk, dan krijgt u daar eerst een prijs voor en beslist u of het doorgaat.'], ['Werken jullie met onderaannemers?', 'Het meeste werk doet onze eigen vaste ploeg. Voor zeer specifieke onderdelen werken we soms met vaste partners die we al jaren kennen, maar de coördinatie en het aanspreekpunt blijven altijd bij ons.'], ['Geldt het 6% btw-tarief voor mijn renovatie?', 'Is uw woning ouder dan 10 jaar en blijft ze hoofdzakelijk een privéwoning, dan valt de renovatie via de aannemer doorgaans onder 6% btw op materiaal en arbeid. Wij regelen het bijhorende papierwerk en bekijken bij het plaatsbezoek of u in aanmerking komt.'], ['Hoe lang duurt een totaalrenovatie?', 'Dat verschilt per project, van enkele weken voor een gedeeltelijke renovatie tot enkele maanden voor een volledige woning. Bij de offerte krijgt u een realistische planning, en één aanspreekpunt bewaakt die tijdens de werken.'], ['Kan ik tijdens de werken in mijn woning blijven wonen?', 'Bij een gedeeltelijke renovatie meestal wel. We werken dan per zone en schermen stof zoveel mogelijk af. Bij een volledige renovatie is het vaak praktischer om er even uit te zijn; dat bespreken we eerlijk op het plaatsbezoek, zodat u vooraf weet waar u aan toe bent.'], ['Werken jullie in mijn regio?', 'Wij werken in Mechelen, Antwerpen, Lier, Willebroek, Bornem, Sint-Niklaas en heel Vlaanderen. Bij het gratis plaatsbezoek bevestigen we meteen de planning.']],
  ...
  badkamerrenovatie: {
    ...
    offer: ['Eén ploeg voor sanitair, tegels en leidingen', 'Eén aanspreekpunt, van het plaatsbezoek tot de oplevering', 'Eigen mensen, alles in eigen beheer', '6% btw als uw woning ouder is dan tien jaar', 'Heeft u maar één badkamer? Toilet en douche gaan als eerste terug open'],
    ...
    reviews: [{ text: '"Oude badkamer was aan vervanging toe. Bad eruit, inloopdouche erin. Drie weken werk, netjes afgewerkt."', name: 'Greet Janssens', role: 'Bad vervangen door douche · Mechelen' }, { text: '"Bad vervangen door een inloopdouche en het toilet mee verplaatst. Alles strak aangesloten. Heel tevreden."', name: 'Peter Maes', role: 'Volledige renovatie · Willebroek' }, { text: '"Op tijd begonnen en op tijd klaar. De douche loopt goed weg, dat was bij de vorige niet zo."', name: 'Linda Verbeeck', role: 'Badkamer op zolder · Bornem' }],
    ...
    typeWerkOpties: ['Volledige badkamer renoveren', 'Inloopdouche plaatsen', 'Bad vervangen door douche', 'Toilet renoveren of verplaatsen', 'Iets anders / advies nodig'],
  ...
  tegelwerken: {
    ...
    topbar: ['Gratis plaatsbezoek binnen 5 werkdagen', 'VCA-gecertificeerd en verzekerd'],
    offerEyebrow: 'Over AB Bouw Groep',
    offerH2: 'Bij tegelwerken bepaalt de lijmlaag of een tegel later loskomt.',
    ...
    offer: ['Vaste prijs per m², offerte = factuur', 'Gratis plaatsbezoek met advies over tegel en legpatroon', 'Eigen vaste ploeg, alles in eigen beheer', 'Vlak gelegd, met een volle lijmlaag en strakke voegen', 'Grootformaat en XXL-tegels vakkundig geplaatst', '6% btw bij een woning ouder dan 10 jaar'],
    steps: [['Gratis plaatsbezoek', 'Een vakman meet op en bespreekt tegelkeuze, legpatroon en voegkleur.'], ['Vaste offerte', 'Eén prijs per m², met het uitvlakken van de ondergrond erin. Dat wordt vaak apart gerekend en verrast mensen achteraf.'], ['Plaatsing door eigen ploeg', 'Wij egaliseren de ondergrond en leggen de tegels vlak en strak doorgevoegd.']],
  ...
  pleisterwerk: {
    ...
    steps: [['Gratis plaatsbezoek', 'Een vakman meet de wanden en plafonds op en bespreekt de afwerking.'], ['Vaste offerte', 'De prijs per m² ligt vast voor we beginnen. Moet er oud pleisterwerk eerst weg, dan staat dat er apart bij.'], ['Uitvoering door eigen ploeg', 'Wij bereiden de ondergrond voor en pleisteren uw wanden en plafonds vlak en strak.']],
    ...
    reviews: [{ text: '"Heel het benedenverdiep opnieuw laten pleisteren. Strak en vlak, geen oneffenheden. En alles netjes afgeplakt voor ze begonnen."', name: 'Wim Heylen', role: 'Wanden en plafonds gepleisterd' }, { text: '"Voorzetwand geplaatst voor de nieuwe slaapkamers en alles mee gepleisterd. Vlakke muren, goed om tegen te schilderen."', name: 'Annelies Maes', role: 'Gyproc + pleisterwerk' }, { text: '"Plafond in de living zat vol haarscheuren. Ze raadden af om er gewoon over te schilderen en hebben het volledig herpleisterd. Een halfjaar later nog geen barst."', name: 'Geert Vermeiren', role: 'Plafond pleisteren' }],
  ...
  oprit: {
    ...
    offer: ['Offerte = factuur, ook bij prijsstijgingen', 'Gratis plaatsbezoek met advies over materiaal en afwatering', 'Stabiele fundering, zodat uw oprit niet verzakt', 'Klinkers, betonklinkers of waterdoorlatende verharding', 'Nette afboording die de oprit op zijn plaats houdt', 'VCA-gecertificeerd en verzekerd'],
    steps: [['Gratis plaatsbezoek', 'Een vakman meet de oprit op, bekijkt de afwatering en bespreekt het materiaal.'], ['Vaste offerte', 'De oprit gaat als geheel in de prijs, fundering en kantopsluiting inbegrepen. Die twee bepalen of hij blijft liggen onder een wagen.'], ['Aanleg door eigen ploeg', 'Wij graven uit, leggen de fundering en plaatsen de klinkers strak en op niveau.']],
    ...
    reviews: [{ text: '"Onze oude oprit was helemaal verzakt. Alles opnieuw aangelegd en twee winters later ligt er nog geen klinker scheef. Top."', name: 'Bram Verschueren', role: 'Oprit vernieuwd' }, { text: '"Op hun advies waterdoorlatende klinkers gekozen. Sindsdien geen plassen meer voor de garage. Tevreden."', name: 'Annelies Peeters', role: 'Waterdoorlatende oprit' }, { text: '"Nieuwe oprit in betonklinkers, strak gelegd. Een groot verschil met de oude die overal verzakt was. Heel tevreden."', name: 'Patrick Wouters', role: 'Oprit in betonklinkers' }],
  ...
  zwembad: {
    ...
    topbar: ['Gratis plaatsbezoek binnen 5 werkdagen', '120+ realisaties'],
    offerEyebrow: 'Over AB Bouw Groep',
    offerH2: 'Bij een zwembad bepaalt het grondwerk of de bak vlak blijft liggen.',
    ...
    offer: ['Offerte = factuur, ook bij prijsstijgingen', 'Gratis plaatsbezoek met advies over type en ligging', 'Beton op maat of een polyester bad in één stuk', 'Graafwerk, plaatsing en afwerking in eigen beheer', 'Terras en omgeving mee afgewerkt indien gewenst', 'VCA-gecertificeerd en verzekerd'],
    steps: [['Gratis plaatsbezoek', 'Een vakman bekijkt uw tuin, de ondergrond en de toegang, en bespreekt type en ligging.'], ['Vaste offerte', 'Van graafwerk tot afwerking in één bedrag. Grondwerk loopt soms anders dan verwacht, en dat hoort u voor we starten en niet erna.'], ['Aanleg door eigen ploeg', 'Wij graven uit, plaatsen het bad en werken alles af, met één vast aanspreekpunt van begin tot eind.']],
    ...
    reviews: [{ text: '"Inbouwzwembad in beton in onze tuin. Graafwerk, bad en terras errond, alles door dezelfde ploeg. Netjes geregeld van begin tot eind."', name: 'Koen De Coninck', role: 'Betonnen inbouwzwembad' }, { text: '"Wij twijfelden tussen beton en polyester. Eerlijk advies dat een polyester bad voor onze tuin volstond, scheelde flink in prijs. Netjes geplaatst."', name: 'Veerle Cools', role: 'Polyester zwembad' }, { text: '"Van uitgraving tot terras alles door dezelfde ploeg. Drie weken werk, netjes geregeld."', name: 'Filip Smets', role: 'Zwembad met terras' }],
  ...
  velux: {
    ...
    offerEyebrow: 'Over AB Bouw Groep',
    offerH2: 'Bij een Velux zit het lekrisico in de aansluiting met de pannen.',
    ...
    steps: [
      ...
      ['Vaste offerte', 'Raam, plaatsing en de binnenafwerking in één bedrag. Een standaardplaatsing start rond 1.250 euro.'],
  ...
  gevelreiniging: {
    ...
    steps: [
      ...
      ['Vaste offerte', 'De prijs per m² hangt af van uw gevelsteen en de methode die daarbij past. Impregneren kan erbij, maar hoeft niet.'],
    ...
    reviews: [
      ...
      { text: '"De ploeg werkte stipt en proper. Groot verschil met ervoor. Heel tevreden."', name: 'Koen Willems', role: 'Gevelreiniging' },
    ],
    faq: [
  ...
  hervoegen: {
    ...
    steps: [
      ...
      ['Vaste offerte', 'Uitslijpen en hervoegen zitten samen in de prijs per m². Blijkt een deel van de gevel nog goed, dan laten we dat staan.'],
  ...
  dakisolatie: {
    ...
    steps: [
      ...
      ['Vaste offerte', 'Het bedrag dekt de isolatie en de afwerking, met de verwachte EPC-winst erbij. Premies wisselen per jaar, dus die rekenen we er niet in.'],
  ...
  platdak: {
    ...
    subBold: '10 jaar garantie op de waterdichtheid',
    heroImg: imgPlatdak,
    ...
    steps: [
      ...
      ['Vaste offerte', 'Isolatie en randafwerking zitten in het bedrag. Zit er nog een oude laag op, dan staat het afvoeren daarvan er apart bij.'],
  ...
  crepi: {
    ...
    steps: [
      ...
      ['Vaste offerte', 'Voor de volledige gevel geldt één prijs per m². Moet er eerst een oude laag af of komt er isolatie onder, dan ziet u dat apart staan.'],
    ...
    reviews: [
      ...
      { text: '"Crepi in een warme grijstint, exact de kleur van het staal. Ramen goed afgeplakt, geen spatten. Netjes opgeleverd."', name: 'Carine Verlinden', role: 'Crepi + kleur' },
  ...
  steenstrips: {
    ...
    steps: [
      ...
      ['Vaste offerte', 'De prijs per m² geldt voor plaatsen en voegen. Op buitenisolatie werkt het anders, en dat rekenen we dan ook anders.'],
...
.rl-thumb::after { content: ""; position: absolute; inset: 0; background: linear-gradient(180deg, rgba(10,22,40,0) 60%, rgba(10,22,40,0.34) 100%); opacity: .7; transition: opacity .15s ease; pointer-events: none; }
.rl-zoom { position: absolute; top: 12px; right: 12px; width: 34px; height: 34px; display: inline-flex; align-items: center; justify-content: center; color: #fff; background: rgba(10,22,40,0.55); border: 1px solid rgba(255,255,255,0.28); border-radius: var(--tr-r-ui); opacity: 1; transition: border-color .15s ease, box-shadow .15s ease, background-color .15s ease, color .15s ease; pointer-events: none; z-index: 2; }
