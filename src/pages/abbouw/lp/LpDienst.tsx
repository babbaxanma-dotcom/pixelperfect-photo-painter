...
export const DIENSTEN: Record<string, Dienst> = {
  totaalrenovatie: {
    ...
    reviews: [{ text: '"We hebben een oude rijwoning volledig laten strippen en heropbouwen. Zeven maanden werk. Wat ik het meest apprecieerde: ik moest nooit zelf achter iemand aanbellen, er was altijd iemand die wist waar we stonden."', name: 'Geert Vandenbussche', role: 'Volledige renovatie rijwoning' }, { text: '"Onze woning uit de jaren zeventig is van binnen helemaal vernieuwd. Elektriciteit, sanitair, isolatie, alles. Het is stoffig geweest, daar moet je op voorbereid zijn, maar elke vrijdag was het opgekuist."', name: 'Annelies Verstraeten', role: 'Totaalrenovatie woning' }, { text: '"Ze hebben ons aangeraden om niet alles ineens te doen en de keuken een jaar uit te stellen. Dat had voor hen minder opgeleverd, dus dat zei wel iets. Beide keren stonden ze er wanneer ze zeiden."', name: 'Bart Coppens', role: 'Gefaseerde renovatie' }],
  ...
  badkamerrenovatie: {
    ...
    reviews: [{ text: '"Onze oude badkamer was echt aan vervanging toe. Nu een douche in plaats van het bad, veel handiger voor mijn man. Drie weken bezig geweest. Content."', name: 'Greet Janssens', role: 'Bad vervangen door douche · Mechelen' }, { text: '"We twijfelden of we het bad zouden houden, maar ze toonden met de maten dat een douche de kleine ruimte een pak groter laat voelen. Achteraf blij dat we geluisterd hebben. Het toilet schoof mee een halve meter op, alles strak aangesloten."', name: 'Peter Maes', role: 'Volledige renovatie · Willebroek' }, { text: '"Kwamen op tijd, hebben gewerkt en zijn niet blijven plakken. De douche loopt goed weg, wat bij de vorige nooit het geval was."', name: 'Linda Verbeeck', role: 'Badkamer op zolder · Bornem' }],
  ...
  tegelwerken: {
    ...
    reviews: [{ text: '"Volledige woonkamer in grote tegels. Kaarsrecht, en ze hebben de dorpel aan de deur mee aangepast zodat er geen randje overblijft. Daar had ik zelf niet aan gedacht."', name: 'Marc Hermans', role: 'Vloertegels woonkamer' }, { text: '"Badkamer volledig betegeld, vloer en wanden. Netjes afgewerkt rond de kranen en strak doorgevoegd. Heel tevreden."', name: 'Liesbeth Coninckx', role: 'Badkamer betegeld' }, { text: '"Goed advies over het legpatroon, ze hebben echt meegedacht. Keuken en hal in één lijn doorgelegd. Mooi gedaan."', name: 'Patrick Goossens', role: 'Keuken- en vloertegels' }],
  ...
  zwembad: {
    ...
    reviews: [{ text: '"Inbouwzwembad in beton in onze tuin. Graafwerk, bad en terras errond, alles door dezelfde ploeg. Netjes geregeld van begin tot eind."', name: 'Koen De Coninck', role: 'Betonnen inbouwzwembad' }, { text: '"Wij twijfelden tussen beton en polyester. Eerlijk advies dat een polyester bad voor onze tuin volstond, scheelde flink in prijs. Netjes geplaatst."', name: 'Veerle Cools', role: 'Polyester zwembad' }, { text: '"Van uitgraving tot terras alles door dezelfde mensen. De tuin lag drie weken open, dat is even doorbijten, maar het resultaat mag er zijn."', name: 'Filip Smets', role: 'Zwembad met terras' }],
  ...
  gevelreiniging: {
    ...
    reviews: [
      ...
      { text: '"De ploeg werkte stipt en proper. Het verschil met ervoor is enorm. De buurvrouw heeft meteen gevraagd wie het gedaan had."', name: 'Koen Willems', role: 'Gevelreiniging' },
    ],
    faq: [
  ...
  hervoegen: {
    ...
    reviews: [
      ...
      { text: '"Slechts één gevel was aangetast. Ze hebben afgeraden om de rest mee te doen, terwijl ik dat zelf had voorgesteld. Nette mensen."', name: 'Inge Mertens', role: 'Gedeeltelijk hervoegen' },
  ...
  crepi: {
    ...
    reviews: [
      ...
      { text: '"Crepi in een warme grijstint, exact de kleur van het staal dat we gekozen hadden. Ze hebben de ramen goed afgeplakt, geen enkele spat op het glas."', name: 'Carine Verlinden', role: 'Crepi + kleur' },
  ...
  steenstrips: {
    ...
    reviews: [
      ...
      { text: '"Roodbruine steenstrips op de voorgevel. Voegen kaarsrecht. Mensen denken dat het echte gevelsteen is, ook van dichtbij."', name: 'Luc Segers', role: 'Steenstrips' },
