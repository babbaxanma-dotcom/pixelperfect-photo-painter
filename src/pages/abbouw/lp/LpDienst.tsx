...
const DIENSTEN: Record<string, Dienst> = {
  ...
  tegelwerken: {
    ...
    reviews: [{ text: '"Volledige woonkamer in tegels van 120 bij 120. Kaarsrecht gelegd, en als je erop tikt klinkt het nergens hol. De voegen lopen door tot in de gang in één lijn."', name: 'Marc Hermans', role: 'Vloertegels woonkamer' }, { text: '"Badkamer volledig betegeld, vloer en wanden. De gaten voor de kranen en de inbouwkraan zaten op de millimeter, geen lelijke randjes silicone om iets weg te moffelen. De grijze voeg loopt overal mooi door."', name: 'Liesbeth Coninckx', role: 'Badkamer betegeld' }, { text: '"We twijfelden over het legpatroon, dus legde de tegelzetter een paar tegels los om te tonen hoe halfsteens versus recht uitkwam. Dat hielp ons echt kiezen. Keuken en hal in één keer doorgelegd, zonder zichtbare overgang in de deuropening."', name: 'Patrick Goossens', role: 'Keuken- en vloertegels' }],
  ...
  terrasaanleg: {
    ...
    reviews: [{ text: '"Nieuw terras in keramische tegels. Ze hebben een lichte helling weg van de gevel gelegd, met het oog zie je dat niet, maar na een regenbui staat er nergens nog een plas."', name: 'Dries Luyckx', role: 'Keramisch terras' }, { text: '"Terras in blauwsteen laten aanleggen. Ze wezen ons op een afvoerputje extra tegen de keldermuur, anders liep het water daar naartoe. Goed dat ze daaraan dachten voor het te laat was."', name: 'Nadine Peeters', role: 'Natuursteen terras' }, { text: '"Oud terras uitgebroken en vervangen door padoek, zonder schroeven in het zicht. Mooie egale planken die nergens kraken. Klaar binnen de week die was afgesproken."', name: 'Wim Claessens', role: 'Houten terras' }],
  ...
  oprit: {
    ...
    reviews: [{ text: '"Onze oude oprit was helemaal verzakt waar de auto altijd stond. Ze hebben veel dieper uitgegraven dan ik dacht en de steenslag in lagen aangereden voor ze begonnen te leggen. Een jaar en twee winters later ligt er nog geen klinker scheef."', name: 'Bram Verschueren', role: 'Oprit vernieuwd' }, { text: '"Voor waterdoorlatende klinkers gekozen op hun advies. Geen plassen meer en regenwater zakt gewoon weg. Vaste prijs vooraf, nette ploeg."', name: 'Annelies Peeters', role: 'Waterdoorlatende oprit' }, { text: '"Nieuwe oprit in betonklinkers. De boordstenen zijn in beton gezet, dus de zijkant zakt niet weg waar de wagen op- en afrijdt. Strak gelegd in een visgraatverband zoals we gevraagd hadden."', name: 'Patrick Wouters', role: 'Oprit in betonklinkers' }],
  ...
  zwembad: {
    ...
    reviews: [{ text: '"Inbouwzwembad in beton in onze achtertuin. De graafmachine moest langs een smalle doorgang naast het huis; ze hadden dat op het plaatsbezoek al ingeschat. Graafwerk, het gestorte bad en het terras errond, alles door dezelfde ploeg."', name: 'Koen De Coninck', role: 'Betonnen inbouwzwembad' }, { text: '"Wij twijfelden tussen beton en polyester. Eerlijk advies dat een polyester bad voor onze tuin volstond, scheelde flink in prijs. Netjes geplaatst."', name: 'Veerle Cools', role: 'Polyester zwembad' }, { text: '"Vaste prijs voor het hele project vooraf, van uitgraving tot terras. Geen verrassingen achteraf, werf elke dag proper. Heel tevreden."', name: 'Filip Smets', role: 'Zwembad met terras' }],
