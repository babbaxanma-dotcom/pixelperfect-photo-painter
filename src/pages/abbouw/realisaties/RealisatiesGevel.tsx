...
const projects: Project[] = [
  {
    img: imgCrepiWit,
    tag: 'Witte crepi + ETICS — Mechelen',
    title: 'Halfopen woning · gevelisolatie met witte crepi',
    story:
      "Halfopen bebouwing uit 1968 met enkele baksteengevel — koud in winter, oncomfortabel in zomer. ETICS-buitenisolatie 14 cm EPS, afgewerkt met Sto Lotusan witte siliconencrepi. EPC-sprong van E naar B. Vensterbanken in geanodiseerd aluminium vernieuwd, dorpels in arduin.",
    specs: { m2: '186 m² gevelvlak', tijd: '6 weken', materiaal: '14 cm EPS + Sto Lotusan crepi', premie: 'Mijn VerbouwPremie €4.020' },
    quote: { text: 'In de zomer is het binnen merkbaar koeler. Niet meer dat klamme gevoel van een oude gevel.', name: 'Annick D., Mechelen' },
    filter: 'etics',
  },
  {
    img: imgCrepiGrijs,
    tag: 'Antraciet crepi — Boom',
    title: 'Nieuwbouw villa · siliconencrepi in antraciet',
    story:
      'Hedendaagse nieuwbouw vroeg om een tijdloze maar moderne gevel. Antraciet siliconencrepi op gestructureerde EPS-platen, met zwart aluminium schrijnwerk en strakke aluminium dorpels. De keuze voor siliconen i.p.v. siloxaan: zelf-reinigend bij regen, makkelijk onderhoud.',
    specs: { m2: '224 m² gevelvlak', tijd: '5 weken', materiaal: 'Sto Lotusan antraciet (silicon-resin)' },
    filter: 'crepi',
  },
  {
    img: imgSteenstrips,
    tag: 'Steenstrips Wienerberger — Lier',
    title: 'Renovatie rijwoning · steenstrips op buitenisolatie',
    story:
      'Authentieke uitstraling behouden zonder concessies aan isolatie. ETICS-buitenisolatie 12 cm met Wienerberger Forum handvorm-steenstrips in warm rood-bruin. Voegwerk in lichte mortel. Het straatbeeld blijft historisch, de E-score springt van F naar C.',
    specs: { m2: '142 m² gevelvlak', tijd: '7 weken', materiaal: '12 cm EPS + Wienerberger Forum handvorm', premie: 'Mijn VerbouwPremie €3.080' },
    quote: { text: 'Niemand ziet dat de gevel geïsoleerd is — dat was net de bedoeling. En binnen is het verschil enorm.', name: 'Stijn V., Lier' },
    filter: 'steenstrips',
  },
  {
    img: imgSierpleister,
    tag: 'Marmorino sierpleister — Bonheiden',
    title: 'Karaktervilla · sierpleister marmorino in inkomhal',
    story:
      'Niet alleen buitengevel: een sierpleister-renovatie van de dubbele inkomhal in marmorino, warm goud-beige. Drie lagen handmatig aangebracht over een glad geschuurde ondergrond. Het oog wordt vanaf de voordeur richting de trappenhal getrokken — pure ambachtelijke afwerking.',
    specs: { m2: '42 m² wandvlak inkomhal', tijd: '4 weken', materiaal: 'Marmorino veneziano goud-beige' },
    filter: 'sierpleister',
  },
  {
    img: imgGevelCrepi,
  ...
  {
    img: imgVillaMod,
    tag: 'Hedendaagse villa — Mechelen-Oost',
    title: 'Nieuwbouw villa · witte crepi + zwart aluminium',
    story:
      'Strakke architecturale villa, vraag van architect: witte siliconencrepi met messcherpe gevellijnen en diepe raamomkadering. EPS-platen met versterkte hoekprofielen, drie lagen finish-mortel handmatig aangebracht. Zwart aluminium schrijnwerk Reynaers — clean detail tot op de millimeter.',
    specs: { m2: '312 m² gevelvlak', tijd: '8 weken', materiaal: 'Sto + Reynaers MasterLine 8' },
    quote: { text: 'De architect kwam zelf na de oplevering een rondje doen. Hij zei: "dit is geen pleisterwerk, dit is precisie-werk."', name: 'Patrick H., Mechelen' },
    filter: 'crepi',
  },
  {
    img: imgGevelStrips,
    tag: 'Steenstrips antraciet — Antwerpen',
    title: 'Naïsolatie rijhuis · steenstrips in antraciet',
    story:
      'Tussenwoning eind 19e eeuw, enkele baksteen, geen isolatie. Volledig ingepakt met 14 cm EPS, daarna geïsoleerde steenstrips in handvorm-antraciet — moderne lookey op de oude woning. Voordeur in dezelfde RAL-tint vernieuwd. Comfort en uitstraling samen.',
    specs: { m2: '128 m² gevelvlak', tijd: '6 weken', materiaal: '14 cm EPS + Vandersanden steenstrips', premie: 'Mijn VerbouwPremie €2.880' },
    filter: 'steenstrips',
  },
  {
    img: imgHoekwoning,
    tag: 'Hoekwoning-renovatie — Antwerpen',
    title: 'Karakter-hoekwoning · gevelherstel + nieuwe pleisterlaag',
    story:
      'Hoekwoning met zichtbare scheuren in de pleisterlaag na zettingen. Eerst de structurele oorzaak onderzocht (geen acuut probleem), daarna oude pleister verwijderd, basisputten gevuld, netwapening en finaal nieuwe siliconen-pleister in zacht crème. Buren langs beide zijden tijdig op de hoogte gehouden.',
    specs: { m2: '156 m²', tijd: '5 weken', materiaal: 'Caparol siliconen-crepi' },
    filter: 'renovatie',
  },
  {
    img: imgStadswoning,
