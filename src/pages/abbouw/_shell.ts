...
/* Hero slideshow — crossfade between background images */
.lf-hero-bg--slides { position: absolute; inset: 0; }
.lf-hero-bg--slides img {
  ...
  transition: opacity 1.6s var(--ease-out-quart, cubic-bezier(0.22,1,0.36,1)),
