    ...
    <div class="lf-testi-marquee" data-testi-marquee>
      ...
      <div class="lf-testi-shift" data-testi-shift>
        <div class="lf-testi-track" data-testi-track>
          ${(() => {
            const reviews = [
              { name: 'Marc Van den Broeck', role: 'Dakrenovatie · Mechelen', img: 'https://images.unsplash.com/photo-1559548331-f9cb98001426?w=160&h=160&q=80&fit=crop&crop=faces', text: 'Van offerte tot oplevering volledig correct. Geen meerwerken, binnen het budget, en de projectleider belde elke vrijdag met een update. Het dak ligt er strak bij.', highlights: ['volledig correct', 'binnen het budget', 'strak'] },
              { name: 'Ellen De Smet', role: 'Totaalrenovatie · Leuven', img: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=160&h=160&q=80&fit=crop&crop=faces', text: 'We hebben drie aannemers vergeleken. AB Bouw was de enige die alle vragen grondig beantwoordde en ook de premieaanvraag voor ons regelde. Resultaat: 3.500 euro terug.', highlights: ['grondig beantwoordde', 'premieaanvraag', '3.500 euro terug'] },
              { name: 'Katrien Peeters', role: 'Badkamer · Antwerpen', img: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=160&h=160&q=80&fit=crop&crop=faces', text: 'Eigen badkamerploeg, eigen tegelzetter, eigen loodgieter. Alles door dezelfde mensen. Dat zie je in het eindresultaat: vakwerk tot in de laatste voeg.', highlights: ['dezelfde mensen', 'vakwerk tot in de laatste voeg'] },
              { name: 'Pieter Janssens', role: 'Nieuwbouw · Bornem', img: 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=160&h=160&q=80&fit=crop&crop=faces', text: 'Eerlijk, snel en correct. We kregen wekelijks een rapport en konden altijd Tom bereiken. Sleutel ontvangen op exact de afgesproken datum, dat is in deze sector zeldzaam.', highlights: ['Eerlijk, snel en correct', 'wekelijks een rapport', 'op exact de afgesproken datum'] },
              { name: 'Sofie Vermeulen', role: 'Gevelrenovatie · Sint-Niklaas', img: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=160&h=160&q=80&fit=crop&crop=faces', text: 'De gevel ligt er strak bij, alle buren komen vragen wie het werk gedaan heeft. Aanrader voor wie kwaliteit en stiptheid belangrijk vindt.', highlights: ['strak', 'kwaliteit en stiptheid'] },
              { name: 'Dirk Maes', role: 'Plat dak · Antwerpen', img: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=160&h=160&q=80&fit=crop&crop=faces', text: 'Lekkend dak op vrijdag gemeld, maandagochtend stond de ploeg op het dak. Probleem opgelost, factuur exact zoals afgesproken. Top service.', highlights: ['maandagochtend stond de ploeg op het dak', 'exact zoals afgesproken', 'Top service'] },
              { name: 'Annelies Claes', role: 'Interieur · Mechelen', img: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=160&h=160&q=80&fit=crop&crop=faces', text: 'Maatwerk in keuken en dressing perfect uitgevoerd. Plinten, plafonds, alles tot op de millimeter. Heldere communicatie van begin tot einde.', highlights: ['perfect uitgevoerd', 'tot op de millimeter', 'Heldere communicatie'] },
              { name: 'Tim Verbeeck', role: 'Carport & oprit · Lier', img: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=160&h=160&q=80&fit=crop&crop=faces', text: 'Carport in hout met aansluitende klinkeroprit. Drie weken werk, geen dag uitloop. De ploeg ruimde elke vrijdag de werf op, dat scheelt enorm met kleine kinderen.', highlights: ['geen dag uitloop', 'ruimde elke vrijdag de werf op'] },
              { name: 'Nathalie Aerts', role: 'Energetische renovatie · Bonheiden', img: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=160&h=160&q=80&fit=crop&crop=faces', text: 'Spouwmuur, dak en glas in één traject. EPC gegaan van F naar C. Ze regelden alle premies, ik moest niets opzoeken. Heel ontzorgd voelt dat.', highlights: ['EPC gegaan van F naar C', 'alle premies', 'ontzorgd'] },
              { name: 'Filip Wouters', role: 'Hellend dak · Puurs', img: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=160&h=160&q=80&fit=crop&crop=faces', text: 'Pannen vernieuwd, isolatie tussen de kepers, alles afgewerkt met zinken bakgoten. Werfleider was elke ochtend ter plaatse om de dag te overlopen. Klasse.', highlights: ['elke ochtend ter plaatse', 'Klasse'] },
              { name: 'Inge Vermeiren', role: 'Badkamer & toilet · Kontich', img: 'https://images.unsplash.com/photo-1554151228-14d9def656e4?w=160&h=160&q=80&fit=crop&crop=faces', text: 'Vier weken stof, en dan een prachtige badkamer. Inloopdouche, zwevend meubel, vloerverwarming. De tegelzetter heeft hier echt zijn handtekening gezet.', highlights: ['prachtige badkamer', 'echt zijn handtekening gezet'] },
              { name: 'Jeroen De Backer', role: 'Aanbouw · Willebroek', img: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=160&h=160&q=80&fit=crop&crop=faces', text: 'Aanbouw van 32m² met grote raampartij. Architect, EPB en uitvoering door één partij — dat scheelt zoveel mailverkeer. Alles correct opgeleverd.', highlights: ['één partij', 'correct opgeleverd'] },
              { name: 'Hilde Goossens', role: 'Gevelisolatie · Boom', img: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=160&h=160&q=80&fit=crop&crop=faces', text: 'Witte crepi op buitenisolatie. Onze stookkost is bijna gehalveerd deze winter. Net en proper gewerkt, ook bij de buren bedankjes achtergelaten.', highlights: ['bijna gehalveerd', 'Net en proper'] },
            ];
...
.lf-blog-btn { display:inline-flex; align-items:center; gap:8px; padding: 10px 18px; background: #d98c03; color:#fff !important; border-radius: 999px; font-size: 12.5px; font-weight: 700; letter-spacing:0.04em; text-transform:uppercase; transition: background 0.2s, transform 0.2s; box-shadow: none; }
.lf-blog-btn:hover { background: var(--accent-hover); transform: translateY(-1px); box-shadow: none; }
...
.lf-blog-track { display: flex; gap: 28px; padding: 6px calc(33.333% + 9.333px) 24px; }
